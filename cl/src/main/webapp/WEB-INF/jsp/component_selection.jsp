    ...
    <div class="main">
        ...
        <div class="component_selection">
            <div class="center_1">
            		<div class="title_box">
                    <div class="title_ip">
                        <p>IP:<input class="input_hide" /></p>
                        <p>HOSTNAME:<input class="input_hide" /></p>
                        <p>PASSWORD:<input class="input_hide"/></p>
                    </div>
                    <div class="title_buttom">
                    	<div class="buttom_type_hui"><div class="buttom_type_text">WEB</div></div>
                    	<div class="buttom_type "><div class="buttom_type_text">PROCESS</div></div>
                    </div>
               		</div>
                    <div class="title_box">
                            <div class="input_move box-shadow-1">
                                <div class="ico_jian_blue">ZOOKEEPER</div>
                            ...
                            <div class="input_movew box-shadow-3">
                                  <div class="ico_add_blue">ZOOKEEPER</div>
                                <p>端口:<input class="input_hide_w"/></p>
                                <p>安装路径<input class="input_hide_w"/></p>
                                <p>dataDir<input class="input_hide_w"/></p>
                                <p>logDir<input class="input_hide_w"/></p>
