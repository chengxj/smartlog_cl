...
<body>	
    ...
    <div class="head">
        <div class="nav">
            <div class="nav1">1 用户名</div>
            <div class="nav1">2 集群管理</div>
            <div class="nav1">3 告警内容</div>
            <div class="nav2">4 安装</div>
        </div>
    </div>
    <div class="main">
        <div class="mount">安装</div>
        <div class="schedule">
            <div class="schedule_1">正在安装zookeeper集群，192.168.99.200......</div>
            <div class="schedule_2">
                <div class="schedule_2_1"></div>
            </div>
        </div>
        <div class="classify">
            <div class="kind">
                <div class="breed_red">ZOOKEEPER</div>
                <div class="breed_yellow">KAFKA</div>
                <div class="breed_green">KAFKA</div>
                <div class="breed box-shadow-blue">KAFKA</div>
                <div class="breed box-shadow-hui">KAFKA</div>
                <div class="breed box-shadow-hui">KAFKA</div>
            </div>
            <div class="kind">
                <div class="breed box-shadow-hui">ZOOKEEPER</div>
                <div class="breed box-shadow-hui">KAFKA</div>
                <div class="breed box-shadow-hui">KAFKA</div>
                <div class="breed box-shadow-hui">KAFKA</div>
                <div class="breed box-shadow-hui">KAFKA</div>
