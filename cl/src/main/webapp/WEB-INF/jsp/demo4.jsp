			...
			<div class="main-content">
				...
				<div class="breadcrumbs" id="breadcrumbs">
					...
					<div class="nav-search" style="top:5px;">
						<button class="btn btn-custom btn-primary" ng-click="go('/example/demo2')">单&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;机</button>&nbsp;
						<button class="btn btn-custom btn-primary" ng-click="go('/example/demo3')">集&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;群</button>&nbsp;
					</div>
					<!-- /section:basics/content.searchbox -->
